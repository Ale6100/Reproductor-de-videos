...
const arraysIgualesOrdenIndistinto = (array1: any[], array2: any[]) => {
    ...
    return lodash.isEqual(array1Sort, array2Sort); // Si luego de ordenarlos los elementos no son iguales en sus posiciones i-ésimas, entonces son arreglos distintos
}
